...
WHERE id = 2 OR email = 'ahmet@berber.com' OR email = 'umut@berber.com' OR full_name LIKE '%Ahmet%' OR full_name LIKE '%Umut%';

UPDATE users
SET full_name = 'Yasin Usta', email = 'yasin@berber.com', work_start = '09:00:00', work_end = '21:00:00'
WHERE id = 3 OR email = 'mehmet@berber.com' OR email = 'yasin@berber.com' OR full_name LIKE '%Mehmet%' OR full_name LIKE '%Yasin%';
